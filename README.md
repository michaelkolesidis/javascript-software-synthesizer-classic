...
**The original version of the JavaScript Software Synthesizer before the ongoing refactoring/redesign. You can find the latest version [here](https://github.com/michaelkolesidis/javascript-software-synthesizer).**
